    ...
    <main style={{ padding: "40px 20px 72px" }}>
      <div style={{ maxWidth: 1180, margin: "0 auto", display: "grid", gap: 24 }}>
        ...
        >
          <div style={{ display: "grid", gap: 12 }}>
            ...
            <p style={{ margin: 0, fontSize: 16, color: "#475569", lineHeight: 1.75, textAlign: "justify", hyphens: "auto" }}>
              Todos los montos se cargan en pesos argentinos. La idea es ordenar costo del producto, llegada a Argentina, gastos unitarios y cargos frecuentes del canal para estimar ganancia neta por unidad y ganancia total al vender todo el stock.
            </p>
            <div style={{ display: "flex", flexWrap: "wrap", gap: 12, marginTop: 4 }}>
              ...
              >
                Cargar valores sugeridos de CEA
              </button>
            </div>
          </div>
        </section>
        ...
        <section style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(320px, 1fr))", gap: 24, alignItems: "start" }}>
          <div style={{ ...boxStyle, display: "grid", gap: 24 }}>
            <div style={{ display: "grid", gap: 12 }}>
              ...
              <p style={{ margin: 0, color: "#64748b", lineHeight: 1.7, textAlign: "justify", hyphens: "auto" }}>
                Primero cargá el costo real por unidad y después los cargos del canal. Los conceptos de Mercado Libre quedan editables porque varían según categoría, publicación, promociones, logística y situación fiscal.
              </p>
            </div>
            ...
            <div style={{ display: "grid", gap: 14 }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 12 }}>
                {[
                  { key: "full", title: "Mercado Envíos Full", text: "Considera almacenamiento y el esquema Full." },
            ...
            <div style={{ display: "grid", gap: 16 }}>
              <div>
                ...
                <p style={{ margin: "8px 0 0", color: "#64748b", lineHeight: 1.7, textAlign: "justify", hyphens: "auto" }}>
                  Estos campos quedan visibles y editables porque Mercado Libre los modifica según categoría, tipo de publicación, logística, cuotas, promociones y reglas impositivas de cada cuenta.
                </p>
              </div>
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 18 }}>
                <NumberField
                  ...
                  step={0.1}
                  hint={mode === "full" ? "Valor sugerido para Full." : "Valor sugerido para estándar o logística propia."}
                />
                <NumberField
                ...
                <NumberField
                  ...
                  hint="Podés ajustarlo con tu dato real o con el simulador oficial."
                />
                <NumberField
                  ...
                  step={0.1}
                  hint="Suele rondar 3%, pero puede variar según provincia y situación fiscal."
                />
                {mode === "full" ? (
                  <>
                    <NumberField
          ...
          <aside style={{ display: "grid", gap: 20 }}>
            <section style={{ ...boxStyle, display: "grid", gap: 16 }}>
              <div style={{ display: "grid", gap: 8 }}>
                <span style={{ fontWeight: 800, color: "#735c0f", textTransform: "uppercase", fontSize: 12, letterSpacing: 0.5 }}>
                  Resultado
                </span>
                <div
                  style={{
                ...
                >
                  <div style={{ fontSize: 14, color: profitPositive ? "#166534" : "#b42318", fontWeight: 800 }}>
                    {profitPositive ? "Ganancia neta por unidad" : "Pérdida estimada por unidad"}
                  </div>
            ...
            >
              ...
              <ul style={{ margin: 0, paddingLeft: 20, color: "#475569", lineHeight: 1.75, textAlign: "justify", hyphens: "auto" }}>
                <li>Ingresá siempre todos los montos en pesos argentinos.</li>
                <li>No mezcles gastos generales como alquiler o internet dentro del costo unitario del producto.</li>
                ...
                <li>Si el margen queda muy fino, normalmente el problema no es solo la comisión: también suele estar mal calculado el costo puesto en Argentina.</li>
              </ul>
