...
export function buildBonusTracks(year: number): BonusTrack[] {
  const items: BonusTrack[] = [
    {
      key: "mundial-2026",
      name: "Bonus track 2026: Mundial de Fútbol",
      timingLabel: "11 de junio al 19 de julio de 2026",
      description:
        "Puede abrir ventanas en cotillón, fanwear, mates, vasos, banderas, decoración para reuniones y productos de consumo grupal.",
      niches: ["cotillón", "fanwear", "banderas", "meetups", "asado y reunión"],
      note:
        "Usarlo como acelerador temático, no como único plan anual. Conviene activar publicaciones antes del arranque del torneo.",
    },
  ];

  items.push({
    key: "colapinto",
    name: "Bonus track 2026: Colapinto / Fórmula 1",
    timingLabel: "Seguimiento táctico durante la temporada",
    description:
      "Oportunidad temática de rápida reacción para fanwear, decoración, accesorios de escritorio, termos, gorras y regalos de nicho.",
    niches: ["fanwear", "stickers", "gorras", "gaming desk", "regalo temático"],
    note:
      "Es una campaña de oportunidad, no una base fija del año. Conviene monitorear actualidad, calendario y conversación del mercado.",
  });
...
export function buildMilestones(campaign: CoreCampaign): Milestone[] {
  return [
    ...
    },
    {
      ...
      description:
        "Momento comercial central de la campaña.",
    },
  ];
}
